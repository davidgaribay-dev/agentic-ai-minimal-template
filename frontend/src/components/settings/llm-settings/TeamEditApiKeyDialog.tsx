/**
 * Dialog for adding or editing an LLM provider API key at team level.
 */
...
interface TeamEditApiKeyDialogProps {
  orgId: string;
  teamId: string;
  provider: string;
  providerName: string;
...
export function TeamEditApiKeyDialog({
  orgId,
  teamId,
  provider,
  providerName,
  ...
  const saveMutation = useMutation({
    mutationFn: async (key: string) => {
      await llmSettingsApi.setTeamProviderApiKey(orgId, teamId, provider, key);
    },
    onSuccess: () => {
      setApiKey("");
      setError(null);
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        {...testId("team-edit-api-key-dialog")}
      ...
      >
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              {hasExistingKey
                ...
                : t("llm_team_add_api_key_desc", { provider: providerName })}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  {...testId("team-edit-api-key-input")}
                  value={apiKey}
          ...
          <DialogFooter>
            ...
            <Button
              {...testId("team-edit-api-key-submit-button")}
              type="submit"
