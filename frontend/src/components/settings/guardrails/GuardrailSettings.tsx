            ...
            <div className="space-y-0.5 pr-4">
              <div className="flex items-center gap-2">
                <Label
                  ...
                  className={cn(
                    isDisabledByHigherLevel && "text-muted-foreground",
                  )}
                >
            ...
            <CollapsibleContent className="space-y-3 pt-4">
              ...
              <div>
                ...
                <KeywordInput
                  ...
                  onChange={(kw) =>
                    handleUpdate({ input_blocked_keywords: kw })
                  }
                  disabled={isDisabled || !guardrailsEnabled}
                />
              </div>
            ...
            <CollapsibleContent className="space-y-3 pt-4">
              ...
              <div>
                ...
                <KeywordInput
                  ...
                  onChange={(kw) =>
                    handleUpdate({ output_blocked_keywords: kw })
                  }
                  disabled={isDisabled || !guardrailsEnabled}
                />
              </div>
