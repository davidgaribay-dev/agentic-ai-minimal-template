/**
 * Team RAG settings component using the new SettingsCard pattern.
 */
...
export function TeamRAGSettings({ orgId, teamId }: TeamRAGSettingsProps) {
  ...
  const { data: teamSettings, isLoading } = useTeamRAGSettings(orgId, teamId);
  ...
  const handleUpdate = (updates: TeamRAGSettingsUpdate) => {
  ...
  const ragEnabled = teamSettings.rag_enabled;
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  checked={teamSettings.allow_user_customization}
                  onCheckedChange={(checked) =>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    min={0}
                    max={1000}
                    value={teamSettings.chunk_overlap}
                    onChange={(e) =>
                      handleUpdate({
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min={1}
                      max={20}
                      value={teamSettings.chunks_per_query}
                      onChange={(e) =>
                        handleUpdate({
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      max={1}
                      step={0.1}
                      value={teamSettings.similarity_threshold}
                      onChange={(e) =>
                        handleUpdate({
