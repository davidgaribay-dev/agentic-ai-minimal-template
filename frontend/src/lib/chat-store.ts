...
export interface ChatMessagesState {
  ...
  setRejectedToolCall: (
    instanceId: string,
    rejected: RejectedToolCall | null,
  ) => void;
...
export const useChatMessagesStore = create<ChatMessagesState>()((set, get) => ({
  ...
  setMessages: (instanceId, messages) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
        (session) => ({
          ...session,
  ...
  updateMessage: (instanceId, messageId, updates) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
  ...
  addMessages: (instanceId, messages) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
  ...
  setIsStreaming: (instanceId, isStreaming) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
  ...
  setConversationId: (instanceId, conversationId) =>
    set((state) => ({
      sessions: {
        ...state.sessions,
        [instanceId]: {
  ...
  setPendingToolApproval: (instanceId, approval) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
  ...
  setRejectedToolCall: (instanceId, rejected) =>
    set((state) => ({
      sessions: updateMatchingSessions(
        state.sessions,
        instanceId,
