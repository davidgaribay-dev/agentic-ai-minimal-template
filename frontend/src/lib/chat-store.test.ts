...
describe("useChatMessagesStore", () => {
  ...
  describe("setMessages", () => {
    ...
    it("syncs messages across sessions with same conversationId", () => {
      ...
      act(() => {
        ...
        useChatMessagesStore
          .getState()
          .setConversationId("panel", conversationId);
  ...
  describe("updateMessage", () => {
    ...
    it("does not modify other messages", () => {
      ...
      act(() => {
        useChatMessagesStore
          .getState()
          .setMessages("test", [message1, message2]);
  ...
  describe("removeMessage", () => {
    ...
    it("handles removing non-existent message gracefully", () => {
      ...
      act(() => {
        ...
        useChatMessagesStore
          .getState()
          .removeMessage("test", "non-existent-id");
      });
  ...
  describe("setIsStreaming", () => {
    it("sets streaming state for a session", () => {
      ...
      expect(useChatMessagesStore.getState().sessions["test"].isStreaming).toBe(
        true,
      );
    ...
    it("syncs streaming state across sessions with same conversationId", () => {
      ...
      expect(useChatMessagesStore.getState().sessions["page"].isStreaming).toBe(
        true,
      );
      expect(
        useChatMessagesStore.getState().sessions["panel"].isStreaming,
      ).toBe(true);
    });
  });
  ...
  describe("setError", () => {
    it("sets error state for a session", () => {
      ...
      expect(useChatMessagesStore.getState().sessions["test"].error).toBe(
        error,
      );
    });
  ...
  describe("setConversationId", () => {
    it("sets conversation id for a session", () => {
      ...
      expect(
        useChatMessagesStore.getState().sessions["test"].conversationId,
      ).toBe("conv-123");
    });
  ...
  describe("setPendingToolApproval", () => {
    it("sets pending tool approval", () => {
      ...
      act(() => {
        useChatMessagesStore
          .getState()
          .setPendingToolApproval("test", approval);
      });
  ...
  describe("syncConversation", () => {
    it("syncs messages to all sessions with matching conversationId", () => {
      ...
      expect(
        useChatMessagesStore.getState().sessions["panel"].messages,
      ).toEqual(messages);
      expect(
        useChatMessagesStore.getState().sessions["other"].messages,
      ).toEqual([]);
    });
  });
  ...
  describe("multi-instance isolation", () => {
    it("isolates sessions with different instanceIds", () => {
      ...
      expect(
        useChatMessagesStore.getState().sessions["page"].messages[0].content,
      ).toBe("page message");
      expect(
        useChatMessagesStore.getState().sessions["panel"].messages[0].content,
      ).toBe("panel message");
    });
  });
});
  ...
  describe("setSelectedConversation", () => {
    it("sets selected conversation id and title", () => {
      act(() => {
        useChatPageStore
          .getState()
          .setSelectedConversation("conv-123", "Test Title");
      });

      expect(useChatPageStore.getState().selectedConversationId).toBe(
        "conv-123",
      );
  ...
  describe("setCurrentTitle", () => {
    it("updates only the title", () => {
      act(() => {
        useChatPageStore
          .getState()
          .setSelectedConversation("conv-123", "Original");
  ...
  describe("clearSelection", () => {
    it("clears selected conversation and title", () => {
      act(() => {
        useChatPageStore
          .getState()
          .setSelectedConversation("conv-123", "Title");
